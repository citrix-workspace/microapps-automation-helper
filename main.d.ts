...
export declare class API {
  ...
  }: GetCitrixCloudTokens): Promise<import("axios").AxiosResponse<any>>;
  /**
  ...
  }: UpdateintegrationConfiguration): Promise<any>;
  /**
  ...
  startSynchronization({
    ...
    integrationId,
    synchronizationType,
  }: StartSynchronization): Promise<any>;
  /**
  ...
  exportIntegration({
    ...
    filePath,
    params,
  }: ExportIntegration): Promise<void>;
  /**
   * get integration log
...
export declare class MicroappsAdmin extends API {
  ...
  createHTTPIntegration({
    ...
    integrationName,
    integrationConfiguration,
  }: CreateHTTPIntegration): Promise<any>;
  /**
  ...
  createJavaIntegration({
    ...
    serviceKey,
    name,
  }: CreateJavaIntegration): Promise<void>;
  /**
  ...
  renameIntegration({
    ...
    newIntegrationName,
    integrationConfiguration,
  }: RenameIntegration): Promise<void>;
  /**
   * Export Application
   * @param {Object} authInstance - Authorized instance for API calls
   * @param {string} microappsAdminUrl - Microapps admin url
...
export declare class Workspace {
  ...
  getFeedCardButton({
    ...
    feedCardId,
    buttonName,
  }: GetFeedCardButton): Promise<import("playwright").ElementHandle<SVGElement | HTMLElement>[]>;
  /**
